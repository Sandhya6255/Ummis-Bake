                    ...
                    .catch(function (res) {
                        // if (res.code !== '' && res.code === 'ERR_BAD_REQUEST') {
                            if (res.response.status === 401) {
                                ...
                                $(".modal-title").html("");
                                $(".modal-footerdiv").html("<button id=redirectv1>ok</button>");
                                $("#redirectv1").addClass("btn btn-primary");
                                $("#redirectv1").on("click", function () {
                                  $("#modalDialog").toggle('hide');
                                });
                                $("#modalDialog").toggle('show');
                              }
                        // }
                            ...
                            $(".modal-title").html("")
                            $(".modal-footerdiv").html("<button id=redirectv2>ok</button>");
                            $("#redirectv2").addClass("btn btn-primary");
                            $("#redirectv2").on("click", function () {
                                $("#modalDialog").toggle('hide');
                            });
                            $("#modalDialog").toggle('show');
                        }
